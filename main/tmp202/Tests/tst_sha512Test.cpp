...
class TestSHA512 : public QObject
{
    Q_OBJECT
...
void TestSHA512::testEmptyString()
{
...
void TestSHA512::testSimpleString()
{
...
void TestSHA512::testBinaryData()
{
    QByteArray data;
    data.append(0x01);
    data.append(0x02);
...
void TestSHA512::testVerifyCorrect()
{
...
void TestSHA512::testVerifyIncorrect()
{
    QString text = "password123";
...
void TestSHA512::testHashConsistency()
{
...
QTEST_APPLESS_MAIN(TestSHA512)
#include "tst_sha512Test.moc"
